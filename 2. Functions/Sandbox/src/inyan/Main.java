...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        float smallCircle1CenterY = size / 3.5f;
        float smallCircle1Radius = size / 6.f;

        float smallCircle2CenterX = size - size / 2.5f;
        float smallCircle2CenterY = size - size / 3.5f;
        float smallCircle2Radius = size / 6.f;

        for(float y = 0; y < size; y++) {
            for(float x = 0; x < size; x += 0.35) {
